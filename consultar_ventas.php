...
<div class="container mt-5">
        <div class="row"> 
            ...
            <div class="col-md-3">
                <h1>Busca por fecha de alquiler</h1>
                    <form action="" method="POST">

                        <input type="text" class="form-control mb-3" name="busqueda" placeholder="AAAA-MM-DD">
                    ...
                    <tbody>
                        <?php
                            ...
                            if(isset($_POST['enviar'])){
                                ...
                                $consulta = $con -> query("SELECT * FROM alquilar WHERE fecha_alquiler = '$busqueda'");
